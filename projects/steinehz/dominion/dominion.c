...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card )
    {
    case adventurer:
      adventurer_action (drawntreasure, state, currentPlayer, cardDrawn, temphand, z);
      return 0;

    case council_room:
      council_room_action (i, currentPlayer, state);
      return 0;
    ...
    case mine:
      m = mine_action (j, state, currentPlayer, choice1, choice2, handPos, i);
      return m;
    ...
    case smithy:
      smithy_action (currentPlayer, state, i, handPos);
      return 0;

    case village:
      village_action (currentPlayer, state, handPos);
      return 0;
